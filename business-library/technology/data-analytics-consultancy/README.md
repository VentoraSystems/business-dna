...
- **Business Name:** Lucidwell Data Partners
- **Version:** 1.0.0
- **Status:** published
...
A solo-deliverable data analytics consultancy built around fixed-scope
ETL pipeline and BI dashboard builds for mid-market companies with
disconnected data and no dedicated data team, always starting with a free
data-audit call. Post-delivery, clients are converted into an optional
monthly analytics retainer covering maintenance and insights reporting.
Distinct from `ai-consulting` (pure strategy advisory, no implementation)
in this same `technology-services` category — this business actually
builds pipelines, dashboards, and predictive models rather than
delivering advice alone.
...
`translationKey` under `businessLibrary.dataAnalyticsConsultancy.*` in
