...
- **Business Name:** Clearpath Leadership Coaching
- **Version:** 1.0.0
- **Status:** published
- **Category:** coaching (see `../../taxonomy/categories.json`)
...
A solo executive-coaching practice for first-time managers and
newly-promoted team leads at fast-growing tech companies, sold either
directly to the individual manager or as a company-sponsored L&D
engagement, always opening with a free discovery call. The
`professionalServices` industry assignment reflects the career/professional-
development nature of this specific coaching niche (as distinct from a
personal-life or skills-education coaching niche, which would instead map
to `education`) — the first business authored under the new `coaching`
category.
...
`translationKey` under `businessLibrary.coachingBusiness.*` in
...
`businessLibrary.coachingBusiness.businessDna.resources.*`.
