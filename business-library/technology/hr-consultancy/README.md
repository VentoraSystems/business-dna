...
- **Business Name:** Northbridge HR Partners
- **Version:** 1.0.0
- **Status:** published
...
> guidance only — how to run and grow a fractional HR consultancy as a
...
A fractional-HR consultancy serving small businesses (10-75 employees)
that need HR expertise without a full-time hire, built on HR audits,
policy/handbook work, and a growth path toward standing monthly
retainers.
...
`translationKey` under `businessLibrary.hrConsultancy.*` in
