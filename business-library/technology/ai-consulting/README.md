...
- **Business Name:** Grayridge AI Advisory
- **Version:** 1.0.0
- **Status:** published
...
An independent, vendor-neutral AI strategy advisory: a solo principal
advisor sells a fixed-fee AI-readiness diagnostic sprint to mid-market
leadership teams, producing a prioritized roadmap of which AI
opportunities are worth pursuing and which aren't — explicitly not an
implementation service. Distinct from both `ai-automation-agency`
(hands-on AI/automation implementation) and `software-house` (bespoke
engineering builds) in this same `technology-services` category — this
business sells judgment and a defensible framework, not code, and can
refer clients to either of those two for the build phase.
...
`translationKey` under `businessLibrary.aiConsulting.*` in
